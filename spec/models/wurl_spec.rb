...
describe Wurl do
  ...
  describe "response" do
    it "formats the GET request correctly" do
      ...
      request = Wurl.new(:request_method => 'get', :request_url => "https://example.com/some_endpoint", :request_parameters => {
          :client_id => "abc123"
      })
    ...
    it 'handles basic auth credentials' do
      ...
      request = Wurl.new(:request_method => 'get', :request_url => 'https://example.com/some_endpoint',
    ...
    it "formats the POST request correctly" do
      ...
      request = Wurl.new(:request_method => 'post', :request_url => "https://example.com/some_endpoint", :request_parameters => {
              :client_id => "abc123"
      })
      request.save
    ...
    it "formats the PUT request correctly" do
      stub_request(:put, "https://example.com/some_endpoint").
        with(:body => "client_id=abc123")
      request = Wurl.new(:request_method => 'put', :request_url => "https://example.com/some_endpoint", :request_parameters => {
          :client_id => "abc123"})
      request.save
    ...
    it "formats the DELETE request correctly" do
      ...
      request = Wurl.new(:request_method => 'delete', :request_url => "https://example.com/some_endpoint", :request_parameters => {
          :client_id => "abc123"
      })
      request.save
